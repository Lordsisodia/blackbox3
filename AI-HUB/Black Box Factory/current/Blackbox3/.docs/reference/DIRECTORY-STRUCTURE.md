...
**Recommendation:**
- If active: Move to `Blackbox3/testing/sandbox/`
...
### For Testing
1. **Test Strategy:** `Blackbox3/testing/BLACKBOX3-TESTING-STRATEGY.md`
2. **Quick Test:** `Blackbox3/testing/TESTING-QUICKSTART.md`
3. **Test Results:** `Blackbox3/testing/TEST-RESULTS-REPORT.md`

### For Reference
1. **Memory System:** `Blackbox3/MEMORY-ARCHITECTURE.md`
2. **Typeless AI:** `Blackbox3/TYPELESS-AI-GUIDE.md`
3. **MCP Skills:** `Blackbox3/.skills/README.md`
...
- Testing docs → `Blackbox3/testing/`
- Agent docs → `Blackbox3/agents/<agent-type>/`

### Creating Templates
- Plan templates → `.plans/_template/`
