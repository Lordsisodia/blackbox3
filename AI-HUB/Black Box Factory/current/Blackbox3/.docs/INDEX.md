...
3. [Skills System](../.skills/README.md) - Available skills
...
| Document | Description | Location |
|----------|-------------|----------|
| **Sprint 1 Verification** | Sprint 1 test results | `testing/SPRINT-1-VERIFICATION.md` |
| **Sprint 6 Test** | Sprint 6 test results | `testing/SPRINT-6-TEST.md` |
