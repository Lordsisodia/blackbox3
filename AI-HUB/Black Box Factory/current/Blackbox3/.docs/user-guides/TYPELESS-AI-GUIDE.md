...
cd .plans/2026-01-12_<timestamp>_build-user-authentication/
...
# Example:
./scripts/promote.sh .plans/2026-01-12_research docs/research/
```
...
# Tell user: "Using .skills/deep-research.md for competitor analysis"
# Tell user: "Applying .skills/mcp-skills/6-playwright-skills.md for testing"
# Tell user: "Following .skills/mcp-skills/3-github-skills.md for PR management"
...
- Path: `.plans/{active_plan}/context/`
- Size: 10 MB
...
- Paths: `.docs/`, `.timeline/`, `.plans/archive/`
- Size: 5 GB
- Retention: Permanent
...
2. cd .plans/<timestamp>_task-description/
...
2. cd .plans/<timestamp>_complex-project/
...
**Plans** (.plans/): Thinking, planning, research
**Runs** (.plans/): Execution, implementation, building
...
| **.skills/** | 20 | MCP skill definitions |
