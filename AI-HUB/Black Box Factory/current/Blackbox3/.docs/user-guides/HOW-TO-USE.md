...
**Then work with AI:**
```bash
cd .plans/<timestamp>_<task-name>/
...
**Output:**
```
Created plan: .plans/2025-01-12_1500_my-first-task/
...
```bash
cd .plans/2025-01-12_1500_my-first-task/
```
...
cd .plans/<timestamp>_analyst-research/
...
# 2. Navigate to plan
cd .plans/<timestamp>_deep-research-session/
...
# Navigate
cd .plans/<timestamp>_competitor-analysis/
