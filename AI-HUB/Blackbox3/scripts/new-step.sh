...
Examples:
  ./.blackbox/scripts/new-step.sh --plan .blackbox/.plans/2025-12-28_1911_deep-research "Defined needs map"
  (cd .blackbox/.plans/<plan> && ../../scripts/new-step.sh "Checkpoint: competitor sweep v1")
EOF
}
